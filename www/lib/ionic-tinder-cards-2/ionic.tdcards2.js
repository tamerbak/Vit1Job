      ...
      return {
        ...
        compile: function (element, attr) {
          return function ($scope, $element, $attr, swipeCards) {
            ...
            var leftIndication = el.querySelector('.no-indication');
            var rightText = el.querySelector('.yes-text');
            var rightIndication = el.querySelector('.yes-indication');
            ...
            var swipeableCard = new SwipeableCardView({
              ...
              leftText: leftText,
              rightText: rightText,
              leftIndication: leftIndication,
              rightIndication: rightIndication,
              drag: $scope.drag,
                ...
                $timeout(function () {
                  if (amt < 0) {
                    if (self.leftText) {
                      ...
                      //self.leftIndication.style.opacity = 0;
                    }
                    if (self.leftIndication) {
                      //self.leftText.style.opacity = fadeFn(-amt);
                      self.leftIndication.style.opacity = 0;
                    }
                    if (self.rightText) {
                      self.rightText.style.opacity = 0;
                      //self.rightIndication.style.opacity = fadeFn(-amt);
                    }
                    if (self.rightIndication) {
                      //self.rightText.style.opacity = 0;
                      self.rightIndication.style.opacity = fadeFn(-amt);
                    }
                  } else {
                    if (self.leftText) {
                      ...
                      //self.leftIndication.style.opacity = fadeFn(-amt);
                    }
                    if (self.leftIndication) {
                      //self.leftText.style.opacity = 0;
                      self.leftIndication.style.opacity = fadeFn(-amt);
                    ...
                    if (self.rightText) {
                      ...
                      //self.rightIndication.style.opacity = 0;
                    }
                    if (self.rightIndication) {
                      //self.rightText.style.opacity = fadeFn(amt);
                      self.rightIndication.style.opacity = 0;
              ...
              onSnapBack: function (startX, startY, startRotation) {
                ...
                var leftIndication = el.querySelector('.yes-indication');
                var rightIndication = el.querySelector('.no-indication');
                ...
                var animation = collide.animation({
                  ...
                  .on('step', function (v) {
                    ...
                    if (rightIndication) rightIndication.style.opacity = 10;
                    if (leftIndication) leftIndication.style.opacity = 10;
                  })
                  .start();

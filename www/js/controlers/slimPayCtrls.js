...
starter
  .controller('SlimPayCtrl', function ($scope, $rootScope, localStorageService) {
    ...
    $scope.$on('$ionicView.beforeEnter', function (event, viewData) {
      ...
      var link = localStorageService.get('urlSlimPay');
      ...
      $(iframe).appendTo($("#iframSlimPay"));

      localStorageService.remove('urlSlimPay');
    });
  });
